...
def build_team_table(team_name, rows):
    def build_header():
        return dbc.Row([
            ...
            dbc.Col("G1", width=1, style={**centered(font_size='2.8vw'),'paddingRight':'2px'}),
            dbc.Col("G2", width=1, style={**centered(font_size='2.8vw'),'paddingRight':'6px'}),
            dbc.Col("G3", width=1, style={**centered(font_size='2.8vw'),'paddingRight':'12px'}),
            dbc.Col("Total", width=1, style={**centered(font_size='2.8vw'),'paddingRight':'10px'}),
        ], style={
            'color': 'white',
            'fontWeight': 'bold',
    ...
    def build_row(row):
        return dbc.Row([
            ...
            dbc.Col(row['member'], width=2, style={**centered(font_size='2.8vw'), 'paddingRight':'12px'}),
            dbc.Col(
                html.Div(
